 ...
 * 一到六年级，初一到初三
 */
public class PrimarySchoolFragment extends BaseFragment {


    public static PrimarySchoolFragment newInstance(String content) {
        PrimarySchoolFragment f = new PrimarySchoolFragment();
        Bundle b = new Bundle();
...
//        LogUtil.e("__initData",String.valueOf(content));
        ...
        if (mModel != null){
            try {
                ...
                LogUtil.e("__initData_primaryschool_mModel != null",String.valueOf(mModel != null));
                LogUtil.e("__initData_primaryschool_recData.size",String.valueOf(mRecData.size()));
                LogUtil.e("__initData_primaryschool_iv.size",String.valueOf(mIvList.size()));
...
//                    String imgUrl = MainApp.imgUrl;
                    ...
                    LogUtil.e("__initData_primaryschool_i",String.valueOf(i));
...
//                        LogUtil.e("__onItemSelected_getScrollY",mRvNav.() + "");
                        ...
                        LogUtil.e("__mFmFocusPart_mAdapterNav_" + position,"FOCUS_ON_PART_NAV");
...
//                mFlNotData.setVisibility(View.GONE);
    ...
    private void showSubject(int position) {
        LogUtil.e("__showSubject",position + "");
        mCurrentPage = 0;
        //先获取选中科目的数据
...
//                startActivity(intent);
            ...
            public void onItemFocusChange(int position, boolean isFocus) {
                if(isFocus){
                    ...
                    LogUtil.e("__mFmFocusPart_mAdapterSubject_" + position,"FOCUS_ON_PART_SUBJECT");
...
//        mTotalCount = courseListDatabean.getTotal_count();//总条目数
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_primary_school;
    }
    ...
    protected void initView(View view) {
        ...
        mRvNav =  view.findViewById(R.id.tv_rv_nav_primary_school);
        mRlContentSubject =  view.findViewById(R.id.rl_content_subject_primary_school);
        mRlContentSubjectRv =  view.findViewById(R.id.rl_content_subject);
        mLlRecommend =  view.findViewById(R.id.ll_recommend_primary_school);
        mSiv1Recommend = view.findViewById(R.id.siv1_primary_school_recommend);
        mSiv2Recommend = view.findViewById(R.id.siv2_primary_school_recommend);
        mSiv3Recommend = view.findViewById(R.id.siv3_primary_school_recommend);
        mSiv4Recommend = view.findViewById(R.id.siv4_primary_school_recommend);
        mSiv5Recommend = view.findViewById(R.id.siv5_primary_school_recommend);
        mSiv6Recommend = view.findViewById(R.id.siv6_primary_school_recommend);
        ...
        mSiv3Recommend.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    ...
                    LogUtil.e("__activity_mSiv3Recommend","onRecommendFocusBottom");
                    mFmFocusTypeHorizontal = FOCUS_ON_LEFT;
...
//                            }
    ...
    public void onClick(View view) {
        try {
            ...
            String type = "";
            switch (view.getId()) {
                case R.id.siv1_primary_school_recommend:
...
//                    intent.putExtra("courseId", mRecData.get(0).getBind_url());
                    ...
                    break;
                case R.id.siv2_primary_school_recommend:
...
//                    intent.putExtra("courseId", mRecData.get(1).getBind_url());
                    ...
                    break;
                case R.id.siv3_primary_school_recommend:
...
//                    intent.putExtra("courseId", mRecData.get(2).getBind_url());
                    ...
                    break;
                case R.id.siv4_primary_school_recommend:
...
//                    intent.putExtra("courseId", mRecData.get(3).getBind_url());
                    ...
                    break;
                case R.id.siv5_primary_school_recommend:
...
//                    intent.putExtra("courseId", mRecData.get(4).getBind_url());
                    ...
                    break;
                case R.id.siv6_primary_school_recommend:
...
//                LogUtil.e("__方向键右_mFmFocusPart",mFmFocusPart + "");
//                LogUtil.e("__方向键右_mRvSubjectSelectedPosition",mRvSubjectSelectedPosition + "");
//                LogUtil.e("__方向键右_mCurrentSubject.size()",mCurrentSubject.size() + "");
                switch (mFmFocusPart){
...
//                mRvNav.scrollToPosition(9);
                ...
                if (dataNav.size() - mNavSelectedPosition < 4){
                    LogUtil.e("__onKeyDown_fm方向下","calculateNavMoveDown__>7_离最后一个<4,滚动也++");
...
//                    mIsConsume = true;
                    ...
                    switch (mRvSubjectSelectedPosition){
                        case 0:
                            mSiv3Recommend.requestFocus();
                            break;
                        case 1:
                            mSiv4Recommend.requestFocus();
                            break;
                        case 2:
            ...
            if (dataNav.size() - mNavSelectedPosition < 3 || mNavSelectedPosition < 4){
                ...
                LogUtil.e("__onKeyDown_fm方向上","calculateNavMoveUp__>7_选中position距离最后一个item_>=3_滚动不--");
