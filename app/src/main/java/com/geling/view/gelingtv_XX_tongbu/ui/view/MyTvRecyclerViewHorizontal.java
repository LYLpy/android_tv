...
/**
 * Created by 26939 on 2018/12/4.
 */

public class MyTvRecyclerViewHorizontal extends RecyclerView {
    private static final String TAG = "TvRecyclerView";

    private int mPosition;
    private BaseFragment mBindFragment;

    public MyTvRecyclerViewHorizontal(Context context) {
        this(context, null);
    }

    public MyTvRecyclerViewHorizontal(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MyTvRecyclerViewHorizontal(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static void MoveToPositionSS(LinearLayoutManager manager, RecyclerView mRecyclerView, int n) {
