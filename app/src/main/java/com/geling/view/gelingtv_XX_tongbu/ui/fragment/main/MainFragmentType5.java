...
import static com.geling.view.gelingtv_XX_tongbu.model.HttpHelper.RECOMMEND_CLICK_TYPE_ORDER;
import static com.geling.view.gelingtv_XX_tongbu.model.HttpHelper.RECOMMEND_CLICK_TYPE_POSITION;

/**
 * 首页
 */
public class MainFragmentType5 extends BaseFragment {
    ...
    private final String indexModuleId = "5";
    @Override
...
//        mLLRoot.setVisibility(View.VISIBLE);
        mLlRootView = view.findViewById(R.id.ll_root_view_home_5);
        mSiv1 = view.findViewById(R.id.siv1_home_5);
        mSiv2 = view.findViewById(R.id.siv2_home_5);
        mSiv3 = view.findViewById(R.id.siv3_home_5);
        mSiv4 = view.findViewById(R.id.siv4_home_5);
        mSiv5 = view.findViewById(R.id.siv5_home_5);
        mSiv6 = view.findViewById(R.id.siv6_home_5);
        ...
        mIvList.add(mSiv5);
        mIvList.add(mSiv6);
        mXBanner = view.findViewById(R.id.xbanner_home_5);
        mLlXBannerParent = view.findViewById(R.id.ll_xbanner_home_parent_5);
...
//                intent.putExtra("courseId",mHomeModelList.get(0).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,2);
                LogUtil.e("__onClick",mHomeModelList.get(0).getCourse_id() + "");
                break;
            case R.id.siv2_home_5:
...
//                intent.putExtra("courseId",mHomeModelList.get(1).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,3);
                LogUtil.e("__onClick",mHomeModelList.get(1).getCourse_id() + "");
                break;
            case R.id.siv3_home_5:
...
//                intent.putExtra("courseId",mHomeModelList.get(2).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,4);
                LogUtil.e("__onClick",mHomeModelList.get(2).getCourse_id() + "");
                break;
            case R.id.siv4_home_5:
...
//                intent.putExtra("courseId",mHomeModelList.get(3).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,5);
                LogUtil.e("__onClick",mHomeModelList.get(3).getCourse_id() + "");
                break;
            case R.id.siv5_home_5:
...
//                intent.putExtra("courseId",mHomeModelList.get(4).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,6);
                LogUtil.e("__onClick",mHomeModelList.get(4).getCourse_id() + "");
                break;
            case R.id.siv6_home_5:
...
//                intent.putExtra("courseId",mHomeModelList.get(5).getCourse_id());
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_POSITION,7);
                LogUtil.e("__onClick",mHomeModelList.get(5).getCourse_id() + "");
                break;
            case R.id.ll_xbanner_home_parent_5:
                type = mHomeBannerList.get(positionX).getBind_type();
                if (type.equals("3")){//表示是url
                    intent = new Intent(getActivity(),WebViewActivity.class);
                    intent.putExtra("url",mHomeBannerList.get(positionX).getBind_url());
                    startActivity(intent);
                }else if (type.equals("1")){//表示是视频
//                    intent = new Intent(getActivity(),CourseDetailActivity.class);
//                    intent.putExtra("courseId",mHomeBannerList.get(positionX).getBind_url());
                ...
                mHttpHelper.recommendClick(indexModuleId,RECOMMEND_CLICK_TYPE_ORDER,positionX + 1                                                                      );
                LogUtil.e("__onClick_courseId",mHomeBannerList.get(positionX).getBind_url() + "");
                break;
        }
        }catch (Exception e){
