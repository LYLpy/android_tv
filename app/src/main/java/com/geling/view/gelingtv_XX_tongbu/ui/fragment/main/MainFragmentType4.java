 ...
 * 首页
 */
public class MainFragmentType4 extends BaseFragment {
    ...
    private final String indexModuleId = "4";
    @Override
...
//        mLLRoot.setVisibility(View.VISIBLE);
        mLlRootView = view.findViewById(R.id.ll_root_view_home_4);
        mSiv1 = view.findViewById(R.id.siv1_home_4);
        mSiv2 = view.findViewById(R.id.siv2_home_4);
        mSiv3 = view.findViewById(R.id.siv3_home_4);
        mSiv4 = view.findViewById(R.id.siv4_home_4);
        mSiv5 = view.findViewById(R.id.siv5_home_4);
        mSiv6 = view.findViewById(R.id.siv6_home_4);
        mSiv7 = view.findViewById(R.id.siv7_home_4);
        ...
        mIvList.add(mSiv6);
        mIvList.add(mSiv7);
        mXBanner = view.findViewById(R.id.xbanner_home_4);
        mLlXBannerParent = view.findViewById(R.id.ll_xbanner_home_parent_4);
...
//                intent.putExtra("courseId",mHomeModelList.get(0).getCourse_id());
                ...
                mHttpHelper.recommendClick(indexModuleId, HttpHelper.RECOMMEND_CLICK_TYPE_POSITION,2);
                break;
            case R.id.siv2_home_4:
...
//                intent.putExtra("courseId",mHomeModelList.get(6).getCourse_id());
                LogUtil.e("__onClick",mHomeModelList.get(6).getCourse_id() + "");
                break;
            case R.id.ll_xbanner_home_parent_4:
