...
public class UniversalVideoView extends SurfaceView
    ...
    private boolean mIsControlling = true;//控制权是否在view这里
...
//            }
    ...
    {
//        if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN){//项目需求，按下方向键时，不处理
//            Log.e("__" + TAG + "onKeyDown_keyCode",keyCode + "");
...
//        当Controller显示时,无法快进/后退，尝试返回true
//        return true;
    ...
    public void seekTo(int msec) {
        Log.e("__" + TAG + "seekTo",isInPlaybackState() + "");
        if (isInPlaybackState()) {
